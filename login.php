...
include ("header.php");?>
 ...
 <?php
//This section processes submissions from the login form 17 
...
if (!empty($_POST['Password'])) {  
    ...
    $p = FALSE;
    echo '<p class = "error"> You forgot to enter the password.</p>';
}
...
$q = "SELECT ID, Firstname, Lastname, Specialization, Password FROM Doktor WHERE (ID = '$id' AND Password = '$p')";
